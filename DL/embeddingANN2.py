...
model=Sequential(
    [Embedding(6000,16,input_length=(100,)),# top 5000 frequent words,16 dimension each token(word)convert into 16 vectors, no_of inputs
...
def encode_review(text):
  ...
  encoded=[]
  for word in words:
    if word in word_index and word_index[word]<6000:
...
while True:
  review=input("you want to give review:")
  if review.lower()=="yes":
